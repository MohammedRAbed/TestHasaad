...
class Vegetables : Fragment() {
    ...
    override fun onCreateView(
        ...
        val proFoodAdapter = VegetablesAdapter(proFood,context!!)
    ...
    class VegetablesAdapter(val pro_food_list: List<ProductFoodClass>,val context: Context) : RecyclerView.Adapter<VegetablesAdapter.MyViewHolder>() {
