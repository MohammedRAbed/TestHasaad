...
class Meat : Fragment() {
    ...
    override fun onCreateView(
        ...
        val proFoodAdapter = MeatAdapter(proFood,context!!)
    ...
    class MeatAdapter(val pro_food_list: List<ProductFoodClass>,val context: Context) : RecyclerView.Adapter<MeatAdapter.MyViewHolder>() {
