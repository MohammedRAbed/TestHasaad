...
class FishFood : Fragment() {
    ...
    override fun onCreateView(
        ...
        val proFoodAdapter = FishFoodAdapter(proFood,context!!)
    ...
    class FishFoodAdapter(val pro_food_list: List<ProductFoodClass>,val context: Context) : RecyclerView.Adapter<FishFoodAdapter.MyViewHolder>() {
